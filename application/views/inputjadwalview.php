                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST">
                    <div class="form-group">
                      <label for="exampleInputName1">ID Jadwal</label>
                      <input type="text" class="form-control" name="id_jadwal" placeholder="ID Jadwal">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail3">Kode Mata Pelajaran</label>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="nip" placeholder="Kode Guru">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword4">Hari & Jam Pelajaran</label>
                      <div class="row">
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="Jam" placeholder="Hari">
                        </div>
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="jam" placeholder="Jam Pelajaran">
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword4">Kelas</label>
