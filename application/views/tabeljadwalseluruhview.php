                ...
                <div class="row" style="margin-top:10px; padding-left:10px;" id="rowoperation">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group" style="padding-top:21px;">
                          <button type="button" id="btngo" class="btn btn-primary btn-xs" onclick="outputTabel()" disabled>Go !</button>
                        </div>
                    </div>
                  </form>
                </div>
                <h4><a href="<?php echo base_url('index.php/JadwalSeluruh/readDataKelas/0'); ?>" style="margin-right:10px; "><i class="mdi mdi-arrow-left-bold-circle-outline">Back</i></a></h4>
              </div>
              </div>
            </div>
          </div>
